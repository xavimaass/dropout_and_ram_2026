...
tau = 0.4 #unstablelong: 0.8 # all: 0.4
n_steps = 4_000 #25 #notrainemb: 50 #longrun: 1_000 #trainemb: 50
lr_in, lr_out = 0.4/d_in, 0.1*d_out #unstable_long: 8.0/d_in, 0.5*d_out #notrainemb: 0.0, 0.0 
#longrun: 0.8/d_in, 0.5*d_out # train_emb: 0.1/d_in, 0.1*d_out
q = 0.5
batch_size = 64
last_particle_single_source = True
eval_every = 20 #longrun1 5 #all: 1
ACTIVATION = tanh
num_repetitions = 10 #10 longrun1 #15 #all: 5
LOOP_SEED = 48
